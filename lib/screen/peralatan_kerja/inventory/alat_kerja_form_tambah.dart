...
class AlatKerjaFormTambah extends StatefulWidget {
  const AlatKerjaFormTambah({Key? key}) : super(key: key);

  @override
  State<AlatKerjaFormTambah> createState() => _AlatKerjaFormTambahState();
}

class _AlatKerjaFormTambahState extends State<AlatKerjaFormTambah> {
    ...
    return GestureDetector(
      ...
      child: Scaffold(
          ...
          appBar: AppBar(
            ...
            title: const Text('Tambah Alat Keja'),
          ),
          body: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          DropdownButtonFormField(
                            ...
                            hint: const Text(
                                "Tekan untuk memilih kondisi Alat Kerja"),
                            onChanged: (value) {
                              setState(() {
                          ...
                          ElevatedButton(
                            ...
                            child: const Text("Tambah Alat Kerja"),
                          ),
                          const SizedBox(
                            height: 20,
                          )
  ...
  Future<void> prosesTambahBarangP3K(
      context,
      nmPeralatanKerja,
      detailLokasi,
      ketPeralatanKerja,
    ...
    try {
      ...
      final Response response =
          await Dio().post('$baseUrl/api/peralatankerja/store',
              data: {
