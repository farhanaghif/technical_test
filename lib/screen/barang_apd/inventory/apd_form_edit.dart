...
class APDFormEdit extends StatefulWidget {
  final APDModel apd;
  const APDFormEdit(this.apd, {Key? key}) : super(key: key);

  @override
  State<APDFormEdit> createState() => _APDFormEditState();
}

class _APDFormEditState extends State<APDFormEdit> {
  ...
  void initState() {
    super.initState();
    _valueNamaAPD.text = widget.apd.nmApd.toString();
    _valueDetailLokasi.text = widget.apd.detailLokasi.toString();
    _valueKeteranganAPD.text = widget.apd.ketApd.toString();
    _tglPembelian = DateTime.parse(widget.apd.tglPembelian.toString());
    _tglAkhirMasaBerlaku =
        DateTime.parse(widget.apd.tglAkhirMasaberlaku.toString());
    _selectedFasilitasPelabuhan = widget.apd.kdFasilitasPelabuhan;
    _selectedKondisiPerangkat = widget.apd.kdKondisiPerangkat;
    _selectedChecklist = widget.apd.isCheck;
    if (widget.apd.isCheck == 'Y') {
      _selectedChecklist = 'Ya';
    }
    if (widget.apd.isCheck == 'N') {
    ...
    return GestureDetector(
      ...
      child: Scaffold(
          ...
          appBar: AppBar(
            ...
            title: const Text('Edit Barang APD'),
          ),
          body: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          DropdownButtonFormField(
                            ...
                            hint: Text(
                                widget.apd.nmFasilitasPelabuhan.toString()),
                            onChanged: (value) {
                              setState(() {
                          ...
                          DropdownButtonFormField(
                            ...
                            hint:
                                Text(widget.apd.nmKondisiPerangkat.toString()),
                            onChanged: (value) {
                              setState(() {
                          ...
                          ElevatedButton(
                            ...
                            child: const Text("Edit Barang APD"),
                          ),
                          const SizedBox(
                            height: 20,
                          )
  ...
  Future<void> prosesEditBarangAPD(
    ...
    try {
      ...
      final Response response =
          await Dio().put('$baseUrl/api/apd/update/${widget.apd.kdApd}',
              data: {
                'nm_apd': namaAPD,
