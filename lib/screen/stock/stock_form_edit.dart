...
class FormEditStock extends StatefulWidget {
  final StockModel stock;
  const FormEditStock(this.stock, {Key? key}) : super(key: key);

  @override
  State<FormEditStock> createState() => _FormEditStockState();
}

class _FormEditStockState extends State<FormEditStock> {
  ...
  void initState() {
    ...
    _valueSatuanStock.text = widget.stock.satuan.toString();
    _valueDetailLokasi.text = widget.stock.detailLokasi.toString();
    _selectedKategoriStock = widget.stock.kdKategoriStock;
    _selectedLokasiPerangkat = widget.stock.kdLokasi;
  }
  ...
  Future<void> prosesTambahPerangkat(
    ...
    try {
      ...
      final Response response =
          await Dio().put('$baseUrl/api/stock/update/${widget.stock.kdStock}',
              data: {
                'nm_stock': namaStock,
      ...
      if (response.statusCode == 200) {
        _onWidgetDidBuild(() {
          String respon = "Berhasil mengubah stock '${_valueNamaStock.text}'";
          ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(
              content: Text(respon),
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          DropdownButtonFormField(
                            ...
                            hint: Text(widget.stock.nmKategoriStock.toString()),
                            onChanged: (value) {
                              setState(() {
                          ...
                          DropdownButtonFormField(
                            ...
                            hint: Text(widget.stock.nmLokasi.toString()),
                            onChanged: (value) {
                              setState(() {
