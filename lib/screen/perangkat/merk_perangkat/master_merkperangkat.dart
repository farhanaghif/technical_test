...
import 'package:risa_reborn/screen/perangkat/merk_perangkat/merkperangkat_form.dart';

class MerkPerangkat extends StatefulWidget {
  const MerkPerangkat({Key? key}) : super(key: key);

  @override
  State<MerkPerangkat> createState() => _MerkPerangkatState();
}

class _MerkPerangkatState extends State<MerkPerangkat> {
  final List bulan = [
    "Januari",
    "Fabruari",
    "Maret",
        ...
        child: Scaffold(
          ...
          floatingActionButton: Padding(
            ...
            child: FloatingActionButton(
              ...
              onPressed: () {
                Navigator.of(context).push(MaterialPageRoute(
                    builder: (context) => const FormTambahMerk()));
              },
            ),
          ),
        ),
